            ...
            <table width="100%" style="border-collapse:separate;border-spacing:0;table-layout:fixed">
                ...
                <tr>
                    <td style="color:#525252;font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:22px;padding:0">
                        ...
                        <p style="line-height:1.5;margin:0 0 17px;text-align:left!important" align="left">Dear {{ $name }},</p>

                        <p style="line-height:1.5;margin:0 0 17px;text-align:left!important" align="left">Welcome to countly.io!</p>
                        <p style="line-height:1.5;margin:0 0 17px;text-align:left!important" align="left">Create surveys for free. Click on the button below to access the app.</p>
                        <table align="center" style="border-collapse:collapse;border-spacing:0;margin:17px auto;table-layout:fixed;text-align:center!important"><tbody><tr><td style="background-color:#29AD62;border:1px none #dadada;border-radius:3px;font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;padding:12px 35px;text-align:left;vertical-align:top" align="left" bgcolor="#29AD62" valign="top">
                                    <a href="{{ url('/') }}" style="background-color:#29AD62;border:none;border-radius:3px;color:white;display:inline-block;font-size:14px;font-weight:bold;outline:none!important;padding:0px;text-decoration:none" target="_blank">
                                        Visit the app
                                    </a>
                                </td></tr></tbody></table>
